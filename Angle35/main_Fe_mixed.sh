...
atomsk --create bcc 2.871939850944315  Fe orient [010]  [-101]   [101] \
-duplicate 29 12 2  \
-prop elastic.txt \
-disloc 0.501*box 0.491*box mixed z y 1.427656 0.0 -2.019011 \
Fe_mixed.lmp
