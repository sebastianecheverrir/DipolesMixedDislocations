...
atomsk --create bcc  2.871939850944315  Fe orient [3-23] [-101] [-1-3-1] \
-duplicate 6 12 2 \
-prop elastic.txt \
-disloc 0.501*box 0.491*box mixed z y 2.435018 0.0 0.430455 \
Fe_mixed.lmp
