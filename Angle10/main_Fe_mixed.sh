...
atomsk --create bcc 2.871939850944315 Fe orient  [131] [-101] [3-23] \
-duplicate 18 12 1  \
-prop elastic.txt \
-disloc 0.501*box 0.491*box mixed z y 0.430455 0.0  2.435018  \
Fe_mixed.lmp
